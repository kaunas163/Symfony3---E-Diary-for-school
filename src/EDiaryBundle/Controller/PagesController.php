...
use EDiaryBundle\Entity\Pages;
use EDiaryBundle\Form\PagesType;
...
class PagesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pages = $em->getRepository('EDiaryBundle:Pages')->findAll();
    ...
    {
        $page = new Pages();
        $form = $this->createForm('EDiaryBundle\Form\PagesType', $page);
    ...
    {
        $deleteForm = $this->createDeleteForm($page);
        $editForm = $this->createForm('EDiaryBundle\Form\PagesType', $page);
