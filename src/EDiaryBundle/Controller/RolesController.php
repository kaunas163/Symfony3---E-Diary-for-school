...
use EDiaryBundle\Form\RolesType;
...
class RolesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $roles = $em->getRepository('EDiaryBundle:Roles')->findAll();
    ...
    {
        $role = new Roles();
        $form = $this->createForm('EDiaryBundle\Form\RolesType', $role);
    ...
    {
        $deleteForm = $this->createDeleteForm($role);
        $editForm = $this->createForm('EDiaryBundle\Form\RolesType', $role);
