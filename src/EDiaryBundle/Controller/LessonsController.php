...
use EDiaryBundle\Entity\Lessons;
use EDiaryBundle\Form\LessonsType;
...
class LessonsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $lessons = $em->getRepository('EDiaryBundle:Lessons')->findAll();
    ...
    {
        $lesson = new Lessons();
        $form = $this->createForm('EDiaryBundle\Form\LessonsType', $lesson);
    ...
    {
        $deleteForm = $this->createDeleteForm($lesson);
        $editForm = $this->createForm('EDiaryBundle\Form\LessonsType', $lesson);
